...
from ..inline import onyxInlineQuery, rand

logger = logging.getLogger(__name__)


@loader.tds
class onyxInfoMod(loader.Module):
    """Show userbot info (onyx3.1.0alpha+)"""

    strings = {
        "name": "onyxInfo",
        "_custom_msg_doc": "Custom message must have {owner}, {version}, {build}, {upd}, {platform} keywords",
        "_custom_button_doc": "Custom buttons.",
        "_photo_url_doc": "You can set your own photo to onyx info.",
        "default_message": (
            "<b>🕶 onyx Userbot</b>\n\n"
            "<b>🤴 Owner:</b> {owner}\n"
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            ...
            "custom_buttons",
            {"text": "🤵‍♀️ Support chat", "url": "https://t.me/onyxChat"},
    ...
    async def info_inline_handler(self, query: onyxInlineQuery) -> None:
        """
        Send userbot info
        @allow: all
        """
        ...
        await query.answer(
            [
                aiogram.types.inline_query_result.InlineQueryResultPhoto(
                    ...
                    parse_mode="html",
                    thumb_url="https://github.com/onyx/onyx/raw/master/onyx/bot_avatar.png",  # noqa: E501
