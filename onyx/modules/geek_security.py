...
@loader.tds
class onyxSecurityMod(loader.Module):
    """Control security settings (onyx3.0.8alpha+)"""
    ...
    async def client_ready(self, client, db) -> None:
        ...
        self._is_onyx = hasattr(self, "inline")
    ...
    async def _add_to_group(
        ...
        if self._is_onyx and not confirmed:
            await self.inline.form(
