...
@loader.tds
class onyxSettingsMod(loader.Module):
    """Advanced settings for onyx"""
    ...
    strings = {
        ...
        "inline_settings": "⚙️ <b>Here you can configure your onyx settings</b>",
    ...
    async def inline__setting(self, call: CallbackQuery, key: str, state: bool) -> None:
        ...
        if (
            ...
            await call.answer(
                "Warning! You enabled NoNick with default prefix! You may get muted in onyx chats. Change prefix or disable NoNick!",
                show_alert=True,
            )
        else:
