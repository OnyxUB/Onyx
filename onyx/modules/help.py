...
class HelpMod(loader.Module):
    """Help module, made specifically for onyx with <3"""
    ...
    strings = {
        ...
        "joined": "👩‍💼 <b>Joined the</b> <a href='https://t.me/onyxChat'>support chat</a>",
        "join": "👩‍💼 <b>Join the</b> <a href='https://t.me/onyxChat'>support chat</a>",
    }
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            ...
            "onyx_emoji",
            "🕶",
            lambda: "onyx-only module bullet",
            "plain_emoji",
            "▫️",
    ...
    async def supportcmd(self, message):
        """Joins the support onyx chat"""
        if await self.allmodules.check_security(
            message, security.OWNER | security.SUDO
        ):
            await self._client(JoinChannelRequest("https://t.me/onyxChat"))

            try:
                await self.inline.form(
                    self.strings("joined", message),
                    reply_markup=[
                        [{"text": "👩‍💼 Chat", "url": "https://t.me/onyxChat"}]
                    ],
                    ttl=10,
                    message=message,
                )
